...
biggest.decrease <- pulitzer %>% filter(Pulitzer.Prize.Winners.and.Finalists..1990.2014 >= 5) %>% 
...
# Which publications had increase in Daily circulation numbers from 2004-2014 and had more Pulitzer Prize Winners from 2004 to 2013 than from 1990 to 2003?

increase.publications <- pulitzer %>% filter(Change.in.Daily.Circulation..2004.2013 > 0) %>%
                    filter(Pulitzer.Prize.Change > 0) %>%
                    select(Newspaper)
